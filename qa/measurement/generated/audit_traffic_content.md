...
```json
{'client_id': 'audit_traffic_user', 'commitment_t': '611934693547841342884796069918442200009494840825685143699382...'}
```

## POST /login/verify (ZKP Step 2)
```json
{'solution_s': '451835907469849381607745832166151429531547773776850500468565...'}
```
...
```json
{'response_type': 'code', 'client_id': 'acas-pkce-client', 'username': 'audit_traffic_user', 'password': 'audit-secret', 'code_challenge': '0o82tQsFW5n5cfexjUM1sBBojY2wTGlbOvd3ojvgOhg', 'code_challenge_method': 'S256'}
```
...
```json
{'grant_type': 'authorization_code', 'client_id': 'acas-pkce-client', 'code': '<opaque-auth-code>', 'code_verifier': 'lIqH1wUsudsPJbGSCABF7WgOjzQHKHwF1Wi23JGmeMAVd00XeqxxVj2X6hHO...'}
```
...
```
{'response_type': 'code', 'client_id': 'acas-authlib-client', 'username': 'audit_traffic_user', 'password': 'audit-secret', 'code_challenge': '0o82tQsFW5n5cfexjUM1sBBojY2wTGlbOvd3ojvgOhg', 'code_challenge_method': 'S256'}
```
...
```
{'grant_type': 'authorization_code', 'client_id': 'acas-authlib-client', 'code': '<opaque-auth-code>', 'code_verifier': 'lIqH1wUsudsPJbGSCABF7WgOjzQHKHwF1Wi23JGmeMAVd00XeqxxVj2X6hHO...'}
```
